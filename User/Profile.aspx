                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-column align-items-center text-center">
                                        <asp:Image ID="imgProfile" runat="server"
                                            ImageUrl='<%# string.IsNullOrEmpty(Eval("profile").ToString()) ? "../Images/user-profile-icon-vector-avatar-600nw-2247726673.jpg" : Eval("profile").ToString() %>'
                        ...
                        <div class="col-md-8">
                            <div class="card mb-3">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <asp:Button ID="btnEdit" runat="server" Text="Edit" CssClass="button button-contactForm boxed-btn" CommandName="EditUserProfile" CommandArgument='<%# Eval("u_id") %>' />
                                        </div>
                                    </div>
                                </div>
                            </div>
